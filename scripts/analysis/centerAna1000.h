...
// Sun Jan  6 19:58:37 2019 by ROOT version 6.14/00
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/output/simulateOutput1000.root
//////////////////////////////////////////////////////////

#ifndef centerAna1000_h
#define centerAna1000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   centerAna1000(TTree *tree=0);
   virtual ~centerAna1000();
...
#ifdef centerAna1000_cxx
centerAna1000::centerAna1000(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hunter/projects/Majorana/output/simulateOutput1000.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hunter/projects/Majorana/output/simulateOutput1000.root");
      }
...
centerAna1000::~centerAna1000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t centerAna1000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t centerAna1000::LoadTree(Long64_t entry)
{
...
void centerAna1000::Init(TTree *tree)
{
...
void centerAna1000::Show(Long64_t entry)
{
...
Int_t centerAna1000::Cut(Long64_t entry)
{
